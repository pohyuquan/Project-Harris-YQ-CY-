...
def w6(req):
    ...
    return render(req, "w6.html", {"title": "Visiting Seattle"})
...
def csv(request, year = None, city = None):
   ...
   if city: df = df[df["County/City"].str.lower().str.contains(str.lower(city))]
...
def pure_template(req):
    params = {"xli" : ["Bessy", "has", "adorable", "cats."],
              "animals" : "dog",
              "di" : {"dog":"ARF", "cat":"MEOW", "tiger":"ROAR"}}
